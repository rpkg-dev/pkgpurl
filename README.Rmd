...
-   If you're enable [styler](https://styler.r-lib.org/) to auto-format your code globally by [setting
...
-   As you might already know, [you are limited to the ASCII character set for your code if you plan on submitting your package to
    ...
    (:partying_face:) -- as long as you exclude the R Markdown source from the built package by putting a line `^Rmd$` in `.Rbuildignore` (which is recommended
    anyway).
