  ...
  result <-
    ...
    paste0("\n",
           if (length(copyright_notice) > 0L) {
             pal::as_comment_string(copyright_notice, "",
                                    sep_paragraphs = FALSE)
           },
           if (length(license_notice) > 0L) {
             paste0(pal::as_comment_string(license_notice),
                    "\n")
           },
...
-   Once pkgdown 2.0.8+ containing [PR #2300](https://github.com/r-lib/pkgdown/pull/2300) is released, change the code block lang ID in the "Parsing example"
    below from `md` back to `rmd`.
